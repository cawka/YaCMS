...
<A HREF=\"#\" onClick=\"cal1x.select(document.forms[0].$this->myName,'anchor1$this->myName','yyyy-MM-dd'); return false;\" TITLE=\"cal1x.select(document.forms[0].$this->myName,'anchor1$this->myName','yyyy-MM-dd'); return false;\" NAME=\"anchor1$this->myName\" ID=\"anchor1$this->myName\"><!--<img style='vertical-align:text-top;' border=0 src='/images/admin/calendar.png'>--></A> &nbsp;
";
		return $ret;
	}
